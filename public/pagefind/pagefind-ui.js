(() => {
	...
	function ct(n, e = {}) {
		...
		if (
			...
			l = l ? l + 2 : 1;
			let a = l;
			while (s.charCodeAt(a) === 45 && Z(s.charCodeAt(a + 1))) {
				const o = l + 1;
...
`),
			...
			An = async () => {
				while (!F) Mn(), await new Promise((g) => setTimeout(g, 50));
			},
			yr = async (g, N) => {
				t(16, (Cn = g || "")),
